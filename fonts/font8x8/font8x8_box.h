...
char font8x8_box[128][8] = {
    ...
    { 0x08, 0x08, 0x08, 0xff, 0xff, 0x18, 0x18, 0x18},   // U+2548 (up L, right H, left H, down H) [label fixed: was U+2547 upstream]
    { 0x18, 0x18, 0x18, 0xff, 0xff, 0x08, 0x08, 0x08},   // U+2547 (up H, right H, left H, down L) [label fixed: was U+254B upstream]
